...
class CompanyController extends Controller
{
    ...
    {
        return view('Appearance.pages.company.index');
    }
    ...
    {
        return view('Appearance.pages.company.create');
    }
    ...
    public function destroy($id)
    {
        $page = Page::find($id);
        $page->delete();
        return redirect()->route('admin.company.index')->with('msg' , 'Company page has been deleted');
    }
}
