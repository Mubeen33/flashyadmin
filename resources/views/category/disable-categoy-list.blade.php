...
@section('page-title','Disabled Categories')
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">Disabled Categories</li>
@endsection    
                                        ...
                                        <table  class="table table-bordered zero-configuration">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sortAble" sorting-column='slug' sorting-order=''>Slug</th>
                                                    <th class="sortAble" sorting-column='title_meta_tag' sorting-order=''>Title</th>
                                                    <th>Description</th>
                                                    <th>Keyword</th>
                                            ...
                                            <tbody id="render__data">
                                                @include('Category.partials.disabled-category-list')
                                            </tbody>
