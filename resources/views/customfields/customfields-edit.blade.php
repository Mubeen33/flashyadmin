    ...
    @include('msg.msg')
            <div class="content-body">
                <section id="basic-horizontal-layouts">
                    <form id="addCustomFields_from" action="{{route('admin.customFields.update.post', $data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"><b>Edit Custom Fields</b><button type="button" class="btn btn-sm btn-warning" style="left: 15px;position: relative;"><a href="{{route('admin.customFieldList.get')}}" style="text-decoration: none;color: #fff">Custom Fields</a></button> </h4>
                                    </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <select class="form-control" name="status">
                                                                            <option value="1" @if(intval($data->active) === 1) selected @endif>Active</option>
                                                                            <option value="0" @if(intval($data->active) === 0) selected @endif>Inactive</option>
                                                                        </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select onclick="removeErrorLevels($(this), 'input')" class="form-control" name="parent_id[]" onchange="get_subcategories(this.value, 0);">
                                                                        ...
                                                                        <option value="{{$data->get_category->id}}" selected>{{$data->get_category->name}}</option>
