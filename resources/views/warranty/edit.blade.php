    ...
    @include('msg.msg')
            <div class="content-body">
                <section id="basic-horizontal-layouts">
                    <form id="addCustomFields_from" action="{{route('admin.warranty.edit.post', $data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div class="row match-height"></div>
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"><b>Edit Products Warranty</b><button type="button" class="btn btn-sm btn-warning" style="left: 15px;position: relative;"><a href="{{route('admin.productWarranty.get')}}" style="text-decoration: none;color: #fff">Products Warranty</a></button> </h4>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-8">    
                                                                    <input type="text" class="form-control tagsInput" data-role="tagsinput" name="warranty" placeholder="Enter choice values" value="{{$data->warranty}}">
                                                                </div>
                                                            </div>    
                                                        </div>
