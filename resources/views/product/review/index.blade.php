                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th title="Product Created Date" class="sortAble" sorting-column='created_at' sorting-order=''>
                                                        Date
                                                    </th>
                                                    <th title="Product Status">Status</th>
                                                    <th>Customer</th>
                                                    <th title="Total Reviews">
                                                        Reivews
                                                    </th>
                                                    <th>Actions</th>
                                                </tr>
                                            ...
                                            <tbody id="render__data">
                                                @include('product.review.partials.list')
                                            </tbody>
                                            
                                        </table>
                                        <input type="hidden" id="hidden__action_url" value="{{ route('admin.productReivews.ajaxPgination') }}">
