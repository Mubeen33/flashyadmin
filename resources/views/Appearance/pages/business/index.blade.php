...
<div class="content-body">
            ...
            <div class="card form-group">
              <div class="card-body">
                <div class="row mb-2">
                  <div class="col-9">
                    <h4>Custom Business Pages <span class="ml-2 text-light" style="font-size: 10px;">(Drag the rows to change the position.)</span></h4>
                  </div>
                  <div class="col-3">
                    <a class="btn btn-primary float-right" href="{{route('admin.business.create')}}">Add New Page</a>
                  </div>
                </div>
                <table class="table table-bordered demo-dt-basic" cellspacing="0" width="100%" 
                id="myTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach(\App\Page::where('page_type' , 'B')->orderBy('position')->get() as $key => $page)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <form id="destroy" action="{{ route('admin.business.destroy' , $page->id) }}" method="POST" style="display: none;">
                                      @method('DELETE')
                                        @csrf
                                    </form>
                                    </li>
