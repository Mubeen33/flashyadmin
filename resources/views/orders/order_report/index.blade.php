                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                <div><h4 class="card-title"><b>{{$vendor->first_name}} {{$vendor->last_name}}'s </b>Order List</h4></div>
                                <div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody id="render__data">
                                                @include('orders.order_report.partials.orders-list')
                                            </tbody>
                                            
                                        </table>
                                        <input type="hidden" id="hidden__action_url" value="{{ route('admin.vendorOrders.ajaxPgination') }}">
