              ...
              <table class="table" style="text-align: left !important;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="20%">
                      @if($top_right_banner_3 && $top_right_banner_3->title !== NULL)
                      <small class="d-block">Title : {{$top_right_banner_3->title}}</small>
                      @endif
                      @if($top_right_banner_3 && $top_right_banner_3->title !== NULL)
                      <small class="d-block">URL : {{$top_right_banner_3->link}}</small>
                      @endif
                    </td>
                    <td width="20%">
                    ...
                    <td width="20%">
                      @if($top_right_banner_3 && $top_right_banner_3->secondary_title !== NULL)
                      <small class="d-block">Title : {{$top_right_banner_3->secondary_title}}</small>
                      @endif

                      @if($top_right_banner_3 && $top_right_banner_3->secondary_link !== NULL)
                      <small class="d-block">URL : {{$top_right_banner_3->secondary_link}}</small>
                      @endif

                      @if($top_right_banner_3 && $top_right_banner_3->secondary_start_time !== NULL && $top_right_banner_3->secondary_end_time)
                      <small class="d-block">Start Time : {{$top_right_banner_3->secondary_start_time}}</small>
                      <small class="d-block">End Time : {{$top_right_banner_3->secondary_end_time}}</small>
                      @endif
                    </td>
                    <td width="5%">
